...
import tv.anypoint.lineartv.sample.scte35.BitSetWriter;
import tv.anypoint.lineartv.sample.scte35.Scte35;
...
public class MainActivity extends Activity {
    protected final String TAG = "ANYPOINT_IPTV_SAMPLE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        scte35Decoder = adView.useScte35Decoder();
        ...
        try {
            switch (keyCode) {
                ...
                case KeyEvent.KEYCODE_DPAD_CENTER:
                    // ex) decode SCTE35
                    int now = (int) System.currentTimeMillis() / 90000;
                    scte35Decoder.decode(Scte35.make(now + 1000, 30000), now);
                    break;
                default:
